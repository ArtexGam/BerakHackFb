    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/Cyber eror')
                time.sleep(2)
                menu()
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/Cyber eror')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
def mini():
    ...
    try:
        ...
        try:
            ...
            time.sleep(2)
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mSabar Jancok \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
